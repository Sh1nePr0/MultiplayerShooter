...
//Declaring custom delegate for the MenuWidget to bind callbacks to
...
public:
	...
	//Custom delegates for the MenuWidget to bind callbacks to
...
protected:
	...
	//
	//Internal callbacks for the delegates from the Online Session Interface delegate list.
